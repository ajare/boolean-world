...
bool setPortalCyberspace(Document* doc, bw::core::Layer* layer, uint32_t portalId, bool cyberspace);
bool setPortalBlocksWater(Document* doc, bw::core::Layer* layer, uint32_t portalId, bool blocksWater);
