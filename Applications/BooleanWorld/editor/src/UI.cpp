...
namespace editor
{
	...
	void renderWorldView(editor::Document* doc, editor::Settings& settings)
	{
		...
		widgets::HelpMarker("Set the starting angle of the player."); ImGui::SameLine();
		...
		widgets::HelpMarker("Set the starting position of the player."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateRegularPolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("Set the number of sides - minimum 3, maximum 8."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateCirclePolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("This value determines the number of sides in the circle polygon."); ImGui::SameLine();
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateCircleSegmentPolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("Arc length in degrees."); ImGui::SameLine();
		...
		widgets::HelpMarker("This value determines the number of sides in the circle segment polygon."); ImGui::SameLine();
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateTorusPolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("This is the thickness of the torus, in [0, 1]."); ImGui::SameLine();
		if (ImGui::SliderFloat("Thickness##CreateTorus", &thickness, 0.01f, 0.99f))
		{
			modified = true;
		}

		widgets::HelpMarker("This value determines the number of sides in the torus polygon."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateTorusSegmentPolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("This is the thickness of the torus segment, in [0, 1]."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("This value determines the number of sides in the torus segment polygon."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateRectanglePolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("This value sets the ratio of the rectangle width to its height."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	tuple<string, CreatePrimitiveFunction, bool> renderCreateSuperformulaPolygon(editor::Document* doc, bw::core::Primitive::Operation op, bw::core::Primitive::FillRule fillRule, uint8_t layer, uint8_t priority, wp::Vector2 const& position, float scale, float angle)
	{
		...
		widgets::HelpMarker("This value determines the number of sides in the superformula polygon."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Preset for initial values."); ImGui::SameLine();
		...
		widgets::HelpMarker("Superformula parameter.  This is usually set to 1."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Superformula parameter.  See https://en.wikipedia.org/wiki/Superformula for examples."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	bw::core::Primitive::Operation setOperationWidget(Document* doc, bw::core::Primitive* primitive, int mode)
	{
		...
		widgets::HelpMarker("CSG operation to perform on primitives."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	bw::core::Primitive::FillRule setFillRuleWidget(Document* doc, bw::core::Primitive* primitive, int mode)
	{
		...
		widgets::HelpMarker("This determines whether intersecting sections are filled or not.  See https://www.angusj.com/clipper2/Docs/Units/Clipper/Types/FillRule.htm for more details."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128); 
	...
	void renderCreateNewPrimitive(editor::Document* doc, editor::Settings& settings)
	{
		...
		widgets::HelpMarker("Choose the primitive type to create.  Path-based primitives are not yet implemented."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("The layer to place the Primitive on"); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Priority determines the order in which primitives are clipped against each other.  Lower value means earlier in the order.  Allowed values are 0 to 255."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Initial position in the world."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Initial size."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Initial angle.  This will create two keyframes in the angle interpolator at times 0 and 1, set to this value."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Create primitive."); ImGui::SameLine();
	...
	void renderTransformFlow(editor::Document* doc, bw::core::Primitive* primitive, vector<bw::core::tTransform> const& flow, bw::core::VertexTransformer::Key key, string const& keyName)
	{
		...
		for (uint32_t i = 0; i < (uint32_t)flow.size(); ++i)
		{
			...
			// Operand 1 type
			widgets::HelpMarker("Type of value to use for the left side of the transform equation.  Either a pre-defined input source, a constant value, or the result of the previous calculation in the transform."); ImGui::SameLine();
			...
			// Operand 1 value
			widgets::HelpMarker("Value to use for the left side of the transform equation.  If 'Input' was selected as type then the selected value will take the incoming output from the relevant Input interpolator.  If 'Constant' was chosen, then enter a value in [0, 1]."); ImGui::SameLine();
			...
			widgets::HelpMarker("Operator to use for the transform equation.  |-| means the absolute difference of the two values.");  ImGui::SameLine();
			ImGui::SetNextItemWidth(64);
			...
			// Operand 2 type
			widgets::HelpMarker("Type of value to use for the right side of the transform equation.  Either a pre-defined input source, a constant value, or the result of the previous calculation in the transform."); ImGui::SameLine();
			ImGui::SetNextItemWidth(96);
			...
			// Operand 2 value
			widgets::HelpMarker("Value to use for the right side of the transform equation.  If 'Input' was selected as type then the selected value will take the incoming output from the relevant Input interpolator.  If 'Constant' was chosen, then enter a value in [0, 1]."); ImGui::SameLine(); 
			ImGui::SetNextItemWidth(112);
	...
	void renderInterpolator(editor::Document* doc, bw::core::Primitive* primitive, bw::core::Interpolator<float> const& lerper, bw::core::VertexTransformer::Key key, int curveIndex, string const& name, string const& lerperType, float proxyValue, float curValue, AdditionalWidgetsFunction addWidgetFunc = {})
	{
		...
		int pointToRemove{ -1 };
		{
			...
			for (uint32_t i = 0; i < numSegments; ++i)
			{
				...
				widgets::HelpMarker("Set the easing function to use when interpolating between the points."); ImGui::SameLine();
				ImGui::SetNextItemWidth(128);
				...
				widgets::HelpMarker("Manual specification of point values.  Note that discontinuous segments are disabled and need to be moved to be editable."); ImGui::SameLine(); 
	...
	void renderValueCapture(editor::Document* doc, bw::core::Primitive* primitive, bw::core::VertexTransformer::Key key)
	{
		...
		widgets::HelpMarker("Capture mode for value."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	void renderAnimatedPropertyEvents(editor::Document* doc, bw::core::Primitive* primitive, bw::core::VertexTransformer::Key key)
	{
		...
		widgets::HelpMarker("Add new event."); ImGui::SameLine();
		...
		for (uint32_t i = 0; i < (uint32_t)events.size(); ++i)
		{
			...
			widgets::HelpMarker("Delete event."); ImGui::SameLine();
			...
			widgets::HelpMarker("Trigger type."); ImGui::SameLine();
			ImGui::SetNextItemWidth(128);
			int triggerType = (int)event.triggerType;

			if (ImGui::Combo("Trigger", &triggerType, triggerTypesStr.c_str(), 6))
			{
				transactUndoableAction(doc, "Set Primitive Event Trigger", bind(setPrimitiveAnimatedPropertyEvent, 
					placeholders::_1, primitive, key, i, event.eventType, (bw::core::AnimatedPropertyEventTriggerType)triggerType, event.value));
			}

			ImGui::SameLine();

			widgets::HelpMarker("Event type."); ImGui::SameLine();
			ImGui::SetNextItemWidth(128);
			int eventType = (int)log2(event.eventType);
			
			if (ImGui::Combo("Action", &eventType, eventTypesStr.c_str(), 6))
			{
				transactUndoableAction(doc, "Set Primitive Event Action", bind(setPrimitiveAnimatedPropertyEvent,
					placeholders::_1, primitive, key, i, 1 << event.eventType, event.triggerType, event.value));
			}

			ImGui::SameLine();

			widgets::HelpMarker("Trigger value."); ImGui::SameLine();
			ImGui::SetNextItemWidth(64);
			float value = event.value;
			if (ImGui::InputFloat("Value", &value, 0.0f, 0.0f, "%.1f", ImGuiInputTextFlags_EnterReturnsTrue))
			{
				transactUndoableAction(doc, "Set Primitive Event Value", bind(setPrimitiveAnimatedPropertyEvent,
					placeholders::_1, primitive, key, i, 1 << event.eventType, event.triggerType, value));
			}
		}

		if (indexToDelete >= 0)
		{
			transactUndoableAction(doc, "Delete Primitive Event", bind(deletePrimitiveAnimatedPropertyEvent,
				placeholders::_1, primitive, key, (uint32_t)indexToDelete));
		}
	}
	...
	void renderAnimatedProperty(editor::Document* doc, bw::core::Primitive* primitive, bw::core::VertexTransformer::Key key, editor::Settings& settings, double globalTime)
	{
		...
		widgets::HelpMarker("Reset animator."); ImGui::SameLine();
	...
	void renderEditPrimitiveGeometry(editor::Document* doc, bw::core::Primitive* primitive, editor::Settings& settings, double globalTime)
	{
		...
		*/
		...
		widgets::HelpMarker("Set the base size of the primitive."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Set the origin (global centre position) of the primitive."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Set the transform offset (ie scale/rotation centre) of the primitive.  This value is in [-1, 1] as it is relative to the primitive boundaries: the cenre cannot be outside the primitive: for that, use orbit distance."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("Set the influence eye offset from the origin.  This determines the position from where input interpolators base their values."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
		...
		widgets::HelpMarker("If selected, this will orient a primitive so that it rotates to face the central point around which it is rotating, if an orbit distance of greater than zero is set."); ImGui::SameLine();
		...
		widgets::HelpMarker("Normally, angle from player to a primitive is taken with 0 degrees being [0, 1].  This value adds an offset (in degrees to that angle)."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	void renderEditPrimitiveSettings(editor::Document* doc, bw::core::Primitive* primitive, editor::Settings& settings)
	{
		...
		widgets::HelpMarker("Distance within which Primitive Time updates."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	void renderPrefabView(editor::Document* doc, editor::Settings& settings)
	{
		...
		widgets::HelpMarker("Tiling type to use for building prefab."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128);
	...
	void renderEditTriggerLineView(editor::Document* doc, editor::Settings& settings, uint32_t triggerLineIndex)
	{
		...
		widgets::HelpMarker("Which side(s) trigger on crossing."); ImGui::SameLine();
		ImGui::SetNextItemWidth(128); 
	...
	{
		if (ImGui::Shortcut(ImGuiKey_N | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
		...
		if (ImGui::Shortcut(ImGuiKey_S | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
		...
		if (ImGui::Shortcut(ImGuiKey_Y | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				if (canRedo())
		...
		if (ImGui::Shortcut(ImGuiKey_Z | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				if (canUndo())
		...
		if (ImGui::Shortcut(ImGuiKey_C | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
		...
		if (ImGui::Shortcut(ImGuiKey_LeftBracket | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				if (doc->hasSelection() && !doc->getSelectedPrimitiveIndices().empty())
		...
		if (ImGui::Shortcut(ImGuiKey_RightBracket | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				if (doc->hasSelection() && !doc->getSelectedPrimitiveIndices().empty())
		...
		if (ImGui::Shortcut(ImGuiKey_B | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				auto const& indices = doc->getSelectedPrimitiveIndices();
		...
		if (ImGui::Shortcut(ImGuiKey_H, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
				goHome(nullptr);
		...
		if (ImGui::Shortcut(ImGuiKey_G | ImGuiMod_Ctrl, 0, ImGuiInputFlags_RouteGlobalLow))
		{
		...
		if (ImGui::Shortcut(ImGuiKey_G | ImGuiMod_Shift, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused() && doc->isActive())
			{
				selectAndHomeGhost(doc);
		...
		if (ImGui::Shortcut(ImGuiKey_Z, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
		...
		if (ImGui::Shortcut(ImGuiKey_P | ImGuiMod_Shift, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused() && doc->isActive())
			{
		...
		if (ImGui::Shortcut(ImGuiKey_F8, 0, ImGuiInputFlags_RouteGlobalLow))
		{
		...
		if (ImGui::Shortcut(ImGuiKey_C, 0, ImGuiInputFlags_RouteGlobalLow))
		{
			if (!ImGui::IsAnyItemActive() && !ImGui::IsAnyItemFocused())
			{
