...
WorldDataGenerator::WorldDataGenerator()
    : mCanClipPrimitives(true), mActiveLayer(0), mFlags(0), mViewerPosition{0.0f, 0.0f}, mViewerAngle(0.0f), mViewerViewDistance(256.0f), mViewFOV(60.0f), mBroadPhaseCulling(BroadPhaseCulling::None), mNarrowPhaseCulling(NarrowPhaseCulling::None) {
}
