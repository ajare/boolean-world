...
namespace WP_NAMESPACE
{
	namespace viz
	{
		...
		class WP_VIZ_API FirepowerMeshRenderer : public StaticRenderer
		{
			firepower::MeshCollisionManager* mwMeshCollisionMgr;
		...
		public:
			...
			FirepowerMeshRenderer(std::string const& name, firepower::MeshCollisionManager* meshCollisionMgr, size_t indexWidth, mpp::ResourceManager* renderResourceMgr);
