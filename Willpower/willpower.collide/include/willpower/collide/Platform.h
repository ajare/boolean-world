...
#if defined(WP_COLLIDE_DLL_EXPORT)
#define WP_COLLIDE_API __declspec(dllexport)
#elif defined(WP_COLLIDE_STATIC_LIB)
#define WP_COLLIDE_API
#else
#if defined(__MINGW32__)
#define WP_COLLIDE_API
#else
#define WP_COLLIDE_API __declspec(dllimport)
#endif
#endif
#elif WP_PLATFORM == WP_PLATFORM_LINUX
#if defined(WP_COLLIDE_DLL_EXPORT)
#define WP_COLLIDE_API __attribute__((visibility("default")))
#else
#define WP_COLLIDE_API
#endif
#endif
