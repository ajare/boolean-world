...
#	if defined(WP_FIREPOWER_DLL_EXPORT)
#		define WP_FIREPOWER_API __declspec( dllexport )
#	elif defined(WP_FIREPOWER_STATIC_LIB)
#		define WP_FIREPOWER_API
#	else
#		if defined(__MINGW32__)
#			define WP_FIREPOWER_API
#		else
#			define WP_FIREPOWER_API __declspec( dllimport )
#		endif
#	endif
#elif WP_PLATFORM == WP_PLATFORM_LINUX
#	if defined(WP_FIREPOWER_DLL_EXPORT)
#		define WP_FIREPOWER_API __attribute__((visibility("default")))
#	else
#		define WP_FIREPOWER_API
#	endif
#endif
