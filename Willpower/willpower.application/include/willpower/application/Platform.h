...
#if defined(WP_APPLICATION_DLL_EXPORT)
#define WP_APPLICATION_API __declspec(dllexport)
#elif defined(WP_APPLICATION_STATIC_LIB)
#define WP_APPLICATION_API
#else
#if defined(__MINGW32__)
#define WP_APPLICATION_API
#else
#define WP_APPLICATION_API __declspec(dllimport)
#endif
#endif
#else
#if defined(WP_APPLICATION_DLL_EXPORT)
#define WP_APPLICATION_API __attribute__((visibility("default")))
#else
#define WP_APPLICATION_API
#endif
#endif
