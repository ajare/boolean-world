...
#if defined(WP_SERIALIZATION_DLL_EXPORT)
#define WP_SERIALIZATION_API __declspec(dllexport)
#elif defined(WP_SERIALIZATION_STATIC_LIB)
#define WP_SERIALIZATION_API
#else
#if defined(__MINGW32__)
#define WP_SERIALIZATION_API
#else
#define WP_SERIALIZATION_API __declspec(dllimport)
#endif
#endif
#elif WP_PLATFORM == WP_PLATFORM_LINUX
#if defined(WP_SERIALIZATION_DLL_EXPORT)
#define WP_SERIALIZATION_API __attribute__((visibility("default")))
#else
#define WP_SERIALIZATION_API
#endif
#endif
