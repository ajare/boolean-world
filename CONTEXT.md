...
**Wedge**:
Additive geometric detail attached beneath the top Arris of a visible Border wall, governed by the World and surfaced with the adjoining ceiling's Sub-material. Derived after the boolean fold in the same visual-detail channel as Chips; it may affect lighting but never collision, spatial queries, surface picking, or authored geometry.
_Avoid_: Chip (subtractive detail), collision geometry, authored Primitive
