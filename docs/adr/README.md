...
| [0050](0050-portals-are-layer-owned-ordered-directed-loops.md) | Portals are Layer-owned ordered directed loops | Partially superseded by ADR-0052 |
| [0051](0051-named-mirror-portals-expand-alongside-legacy-loops.md) | Named Mirror Portals expand alongside legacy loops | Partially superseded by ADR-0052 |
| [0052](0052-portals-have-only-layer-local-identities-and-explicit-targets.md) | Portals have only Layer-local identities and explicit targets | Accepted |
